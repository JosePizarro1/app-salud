...
enum BreathingPhase { inhale, hold, exhale, done }
  ...
  void _startPhase(BreathingPhase phase) {
    ...
    setState(() {
      ...
      if (phase == BreathingPhase.inhale) {
        ...
        _progressController.value = 1.0; // Mantiene el indicador de progreso lleno
      } else if (phase == BreathingPhase.exhale) {
        _secondsLeft = 8;
        _progressController.duration = const Duration(seconds: 8);
        _progressController.reverse(from: 1.0); // Se vacía el progreso progresivamente
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Con cada respiración estás liberando la tensión y ayudando a tu cuerpo a relajarse profundamente.',
...
// Pintor del círculo de progreso con gradientes y estilos
...
// Dibujo del globo de diálogo estilo comic con borde sólido
