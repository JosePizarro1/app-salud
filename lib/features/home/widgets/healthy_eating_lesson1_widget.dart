...
class HealthyEatingLesson1Widget extends StatefulWidget {
  final VoidCallback? onCorrectAnswer;
  const HealthyEatingLesson1Widget({super.key, this.onCorrectAnswer});

  @override
  State<HealthyEatingLesson1Widget> createState() => _HealthyEatingLesson1WidgetState();
}

class _HealthyEatingLesson1WidgetState extends State<HealthyEatingLesson1Widget> {
  ...
  void _handleOptionSelected(int optionId) {
    if (optionId == 1) {
      // Correct option selected (Oatmeal & fruit)
      setState(() {
      ...
      children: [
        ...
        FadeInUp(
          ...
          child: Padding(
            ...
            child: Text(
              '¡Excelente elección! La avena y las frutas te darán energía estable para rendir en tu examen.',
              textAlign: TextAlign.center,
              style: GoogleFonts.outfit(
                fontSize: 19.5,
                fontWeight: FontWeight.bold,
        ...
        FadeInUp(
          ...
          child: Container(
            ...
            child: Text(
              '¿Sabías que...? Los carbohidratos complejos como la avena liberan energía de forma progresiva, evitando picos de azúcar y manteniendo tu cerebro concentrado por más tiempo.',
              style: GoogleFonts.outfit(
                fontSize: 15.5,
      ...
      children: [
        ...
        FadeInUp(
          ...
          child: Padding(
            ...
            child: Text(
              'El exceso de azúcar produce energía rápida pero luego disminuye.',
              textAlign: TextAlign.center,
              style: GoogleFonts.outfit(
                fontSize: 20,
        ...
        FadeInUp(
          ...
          child: GestureDetector(
            onTap: () {
              ...
              setState(() {
                _viewState = Lesson1State.question;
              });
            },
            child: Container(
  ...
  Widget build(BuildContext context) {
    Widget content;
    switch (_viewState) {
      case Lesson1State.question:
        content = _buildQuestionContent();
        break;
      case Lesson1State.correct:
        content = _buildCorrectContent();
        break;
      case Lesson1State.incorrect:
